...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; bg-color:red">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://panel.dropfile.webstarterz.com"><i class="fa fa-dashboard fa-lg fa-fw"></i>SNAKE VPN PANEL</a>
        </div>
                ...
                <ul class="nav" id="side-menu">
                    <li class="sidebar-search">
                        <div class="row">
                            ...
                            <div class="col-xs-7">
                                <h4 class="text-muted"><?php if ($_SESSION['is_admin']) { echo"ADMINr"; } else{echo "User";}?></h4> <h3><?= $_SESSION['username'] ?></b></3>
                            </div>
                        </div>
                    </li>
						...
						<?php if ($_SESSION['is_admin']): ?>
                            ...
                            <li>
                                <a href="<?= base_url('panel/administrator/'.$_SESSION['username'].'/server') ?>"><i class="fa fa-th-list fa-fw"></i>Servers</a>
                            </li>
                            <li>
                                <a href="<?= base_url('admin/notify') ?>"><span class="glyphicon glyphicon-envelope"></span> message<?php if (isset($msg)): ?>
									<span class="badge"><?= count($msg) ?></span>
                                
                                <?php endif; ?>
                                </a>
                            </li>
						<li><a href="<?= base_url('panel/'.$_SESSION['username'].'/setting')?>"><i class="fa fa-key"></i>
						        Change password </a> </li>
							<li><a href="<?= base_url('admin/asset')?>"><i class="fa fa-phone"></i>Add a paid account </a> </li>
                        <?php else: ?>
                         <li>
                              <a href="<?= base_url('panel/reseller/'.$_SESSION['username'].'/server') ?>"><i class="fa fa-shopping-cart fa-fw"></i>Servers</a>
                        </li>
                        <li>
                              <a href="<?= base_url('panel/reseller/cek_account/'.$_SESSION['username']) ?>"><i class="fa f--users "> </i> checking accounts </a>
                        </li>
                        <li>
							<a href="<?= base_url('panel/'.$_SESSION['username'].'/setting')?>"><i class="fa fa-gear fa-fw"></i> Change password </a>
                        </li>
                        <?php endif; ?>
					  <li>
                        <a href="<?= base_url('panel/'.$_SESSION['username'].'/logout')?>"><i class="fa fa-sign-out fa-fw"></i> Sign out </a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>

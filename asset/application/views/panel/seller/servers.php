...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
    <h3 class = "page-header"> Server list </h3>
            <div class="dropdown pull-right">
				<button><a href="<?= base_url('panel/reseller/'.str_replace(' ','-',$_SESSION['username']).'/addsaldo-via-hp') ?>"
				> Top up credit </a>.</button>
            </div>
    ...
    <div class="row">
       <div class="col-xs-6 col-md-5 col-md-4 col-lg-3">
            <div class="well">Credit: <B><?= $user -> saldo ?></B></div>
        </div>
    </div>
    <div class="row">
            <div class="col-lg-12">
        ...
        <?php foreach($server as $row): ?>
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="panel panel-default">
                    ...
                    <table class="table">
                        <tr>
                           <td>Country</td> <td><?= $row['Location']?></b></td>
                        </tr>
                        <tr>
                           <td>Host/IP</td><td><?= $row['HostName']?></b></td>
                        </tr>
                        <tr>

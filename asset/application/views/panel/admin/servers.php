...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">List of servers
            <?php if (isset($_SESSION['is_admin'])): ?>
                <a href="<?= base_url('panel/administrator/'.str_replace(' ','-',$_SESSION['username']).'/addserver') ?>" class="btn btn-default pull-right"><i class="fa fa-plus fa-fw"></i>Add Server</a>
                <?php endif; ?>
            </h1>
        </div>
    </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="panel panel-default">
                    ...
                    <table class="table table-condensed">
                        <tr>
                            <td>Country</td><td><?= $row['Location']?></td>
                        </tr>
                        <tr>
